...
namespace bloodstrike
{
    ...
    namespace renderer
    {
        ...
        static ID3D11ShaderResourceView *junior_srv = nullptr;
        static ID3D11ShaderResourceView *moha_srv = nullptr;
        static ID3D11ShaderResourceView *aim_icon_srv = nullptr;
        static ID3D11ShaderResourceView *visuals_icon_srv = nullptr;
        static ID3D11ShaderResourceView *misc_icon_srv = nullptr;
        static ID3D11ShaderResourceView *settings_icon_srv = nullptr;
